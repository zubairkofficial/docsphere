                                    ...
                                    <div className="dropdown-menu dropdown-menu-md rounded-3">
                                        <div className="dropdown-content py-3">
                                            <div className="border border-light rounded-3">
                                                ...
                                                <a className="d-flex px-3 py-2 bg-primary bg-opacity-10 rounded-bottom-3" href="profile.html">
                                                    <div className="media-group">
                                                        <div className="media media-sm media-middle media-circle text-bg-primary"><img src="images/avatar/a.png" /></div>
                                                        <div className="media-text">
                                                            <h6 className="fs-6 mb-0">{ Helpers.authUser.name }</h6>
                                                            <span className="text-light fs-7">{ Helpers.authUser.email }</span>
                                                        </div>
