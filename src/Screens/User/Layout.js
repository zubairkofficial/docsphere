                ...
                <ul className="nk-menu">
                  ...
                  {/* <li className="nk-menu-item has-sub">
                                        <a href="#" className="nk-menu-link nk-menu-toggle">
                                            <span className="nk-menu-icon"><em className="icon ni ni-signin"></em></span><span className="nk-menu-text">Auth Pages</span>
                                        </a>
                                    ...
                                    <li className="nk-menu-item">
                                        <a href="component-buttons.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-view-grid-wd"></em></span><span className="nk-menu-text">Buttons</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-badges.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-ticket"></em></span><span className="nk-menu-text">Badges</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-alert.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-alert"></em></span><span className="nk-menu-text">Alert</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-dropdown.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-notify"></em></span><span className="nk-menu-text">Dropdown</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item has-sub">
                                        <a href="#" className="nk-menu-link nk-menu-toggle">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-todo"></em></span><span className="nk-menu-text">Forms</span>
                                        </a>
                                        <ul className="nk-menu-sub">
                                            <li className="nk-menu-item">
                                    ...
                                    <li className="nk-menu-item">
                                        <a href="component-tabs.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-browser"></em></span><span className="nk-menu-text">Tabs</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-modals.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-property"></em></span><span className="nk-menu-text">Modal</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-popover-tooltip.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-chat"></em></span><span className="nk-menu-text">Popover &amp; Tooltips</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-accordion.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-view-x7"></em></span><span className="nk-menu-text">Accordion</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-card.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-card-view"></em></span><span className="nk-menu-text">Card</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
                                        <a href="component-offcanvas.html" className="nk-menu-link">
                                            <span className="nk-menu-icon is-alt"><em className="icon ni ni-layout-alt"></em></span><span className="nk-menu-text">Offcanvas</span>
                                        </a>
                                    </li>
                                    <li className="nk-menu-item">
